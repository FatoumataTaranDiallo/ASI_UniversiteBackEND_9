...
public class BasicBdBuilder(IRepositoryFactory repositoryFactory) : BdBuilder(repositoryFactory)
{
    ...
    [
        new Note { UeId = 1, EtudiantId = 2, Valeur = 12m },
        new Note { UeId = 1, EtudiantId = 3, Valeur = 8.5m },
        new Note { UeId = 1, EtudiantId = 4, Valeur = 16m },
        new Note { UeId = 2, EtudiantId = 2, Valeur = 14m },
        new Note { UeId = 2, EtudiantId = 3, Valeur = 6m },
        new Note { UeId = 3, EtudiantId = 4, Valeur = 11.5m },
        new Note { UeId = 4, EtudiantId = 1, Valeur = 10m },
        new Note { UeId = 4, EtudiantId = 5, Valeur = 18.3m },
        new Note { UeId = 4, EtudiantId = 6, Valeur = 12m }
    ];
    ...
    protected override async Task NoterAsync()
    {
        ...
        {
            await new AddNoteToEtudiantUseCase(repositoryFactory).ExecuteAsync(note.EtudiantId, note.UeId, note.Valeur);
        }
    }
